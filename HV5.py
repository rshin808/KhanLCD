...
class VISetN(Temp):
    def __init__(self, name = "VISetN", filename = "VISetN.csv", channel = 0):
        ...
        self._V.append(TS(65, 53, 14, "0", font14hL))
        self._V.append(TS(76, 53, 14, "0", font14hL))
        self._V.append(TS(87, 53, 14, "0", font14hL))
        self._V.append(TS(98, 53, 14, ".", font14hL))
        self._V.append(TS(102, 53, 14, "0", font14hL))
        self._V.append(TS(113, 53, 14, "0", font14hL))
...
VIMeas1 = VIMeas(font14h, "VIMeas", "VIMeas1.csv")
