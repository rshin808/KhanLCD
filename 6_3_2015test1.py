            ...
            if check == False:
                ...
                for v in range(len(self._V)):
                    if v != 4:
                        ...
                        # FIX check here for non-updated square
                        else:
...
class VISet(Temp):
    ...
    def update_strings(self, adc, dac, bus, display, check_time):
        if (dt.datetime.now() - check_time).total_seconds() >= 0.39: 
            ...
            for count in range(1, len(output_Vs) + 1):
                if count == 5:
                    self._VD[0].update_string("{:.2f}".format(output_Vs[0] / 5.0 * 4000.0).rjust(7) + "V ")
                    self._VD[0].draw_string((0, 0), self._back, display)
                elif count == 3:
                    self._VD[1].update_string("{:.2f}".format(output_Vs[1] / 5.0 * 4000.0).rjust(7) + "V ")
                    self._VD[1].draw_string((0, 0), self._back, display)
                elif count == 4:
                    self._VD[2].update_string("{:.2f}".format(output_Vs[2] / 5.0 * 4000.0).rjust(7) + "V ")
                    self._VD[2].draw_string((0, 0), self._back, display)
                elif count == 8:
                    self._VD[3].update_string("{:.2f}".format(output_Vs[3] / 5.0 * 4000.0).rjust(7) + "V ")
                    self._VD[3].draw_string((0, 0), self._back, display)
                elif count == 7:
                    self._ID[0].update_string("{:.4f}".format(output_Is[0]) + "mA ")
                    self._ID[0].draw_string((0, 0), self._back, display)
                elif count == 1:
                    self._ID[1].update_string("{:.4f}".format(output_Is[1]) + "mA ")
                    self._ID[1].draw_string((0, 0), self._back, display)
                elif count == 2:
                    self._ID[2].update_string("{:.4f}".format(output_Is[2]) + "mA ")
                    self._ID[2].draw_string((0, 0), self._back, display)
                elif count == 6:
                    self._ID[3].update_string("{:.4f}".format(output_Is[3]) + "mA ")
                    self._ID[3].draw_string((0, 0), self._back, display)
